...
//-- 操作类型
/*------------------------------------------------------ */
$_LANG['log_action']['use'] = '使用';
$_LANG['log_action']['reset'] = '重置';
$_LANG['log_action']['reapply'] = '重申';
$_LANG['log_action']['apply'] = '申请';
$_LANG['log_action']['enter'] = '进入';
$_LANG['log_action']['execute'] = '执行';
$_LANG['log_action']['view'] = '浏览';
$_LANG['log_action']['query'] = '查询';
...
$_LANG['log_action']['zxproduct'] = '征信产品';
$_LANG['log_action']['zxproduct_cate'] = '征信产品分类';
$_LANG['log_action']['zxproduct_api'] = '征信产品供应商';

$_LANG['log_action']['suppliers'] = '供货商管理';

$_LANG['log_action']['reg_fields'] = '会员注册项';

$_LANG['log_action']['account_detail'] = '账户明细';
$_LANG['log_action']['search_log'] = '查询记录';
$_LANG['log_action']['account_log'] = '充值记录';
$_LANG['log_action']['op_info'] = '个人信息';
$_LANG['log_action']['mess_log'] = '消息记录';
$_LANG['log_action']['op_log'] = '操作记录';
$_LANG['log_action']['op_list'] = '操作员列表';
$_LANG['log_action']['op_list_wait'] = '待审核列表';
$_LANG['log_action']['op_list_fail'] = '审核失败列表';
$_LANG['log_action']['op_info_detail'] = '操作员信息详情';
$_LANG['log_action']['op_add_new'] = '新增操作员';
$_LANG['log_action']['op_update_new'] = '修改操作员';
$_LANG['log_action']['op_password'] = '操作员密码';
$_LANG['log_action']['op_role'] = '操作员角色';
$_LANG['log_action']['op_perm'] = '操作员权限';
$_LANG['log_action']['op_status_open'] = '操作员用户状态-启用';
$_LANG['log_action']['op_status_close'] = '操作员用户状态-停用';
$_LANG['log_action']['op_finance_distribution'] = '操作员余额分配';
$_LANG['log_action']['account_deposit'] = '在线充值';
$_LANG['log_action']['company_info'] = '代理商信息';
$_LANG['log_action']['zhbg'] = '综合报告查询';
$_LANG['log_action']['edit_password'] = '修改密码';
$_LANG['log_action']['sup_admin'] = '代理商管理';
$_LANG['log_action']['op_tcbi_saving'] = '操作员二级余额充值';
$_LANG['log_action']['tcbi_account_log'] = '二级余额变动记录';
?>