...
$_LANG['cp_home'] = '时间征信 管理中心';
$_LANG['copyright'] = '版权所有-广州时间沙漏信用管理有限公司- <a href="http://www.miitbeian.gov.cn" target="_blank" style="text-decoration:none;color:#9CACAF">粤ICP备16112591号</a><img src="../themes/68ecshopcom_360buy/images/img/icon-beian.png">，并保留所有权利。';
...
$_LANG['kilogram'] = '千克';
/* 新菜单分类部分 */
$_LANG['00_new_start'] = '全局概览';
$_LANG['01_member'] = '会员管理';
$_LANG['02_pri_admin'] = '权限管理';
$_LANG['03_notice_admin'] = '消息管理';
$_LANG['04_article_admin'] = '文章管理';
$_LANG['05_product_admin'] = '产品管理';
$_LANG['06_app_admin'] = 'APP管理';
/*会员管理*/
$_LANG['01_member_sup'] = '代理商管理';
$_LANG['02_member_op'] = '操作员管理';
$_LANG['03_member_admin'] = '管理员管理';
$_LANG['04_op_list'] = '操作员审核列表';
$_LANG['05_rlog_list'] = '次数记录';
$_LANG['06_orglog_list'] = '机构充值记录';
$_LANG['07_supplier_consume_list'] = '代理商消费记录';
$_LANG['07_supplier_recharge_log'] = '代理商充值记录';
/*权限管理*/
$_LANG['01_pri_role'] = '角色管理';
$_LANG['02_pri_admin'] = '权限管理';
$_LANG['03_prod_scheme'] = '产品方案';
/*消息管理*/
$_LANG['01_notice_write'] = '写信息';
$_LANG['02_notice_send'] = '发件箱';
$_LANG['03_notice_achieve'] = '收件箱';
$_LANG['04_notice_template'] = '模板';
$_LANG['05_chat_booke'] = '通讯录';
$_LANG['06_notice_log'] = '消息通知';
$_LANG['07_message_broad'] = '留言板';
/*文章管理*/
$_LANG['01_art_colum'] = '栏目';
/*产品管理*/
$_LANG['01_product_add'] = '添加产品';
$_LANG['02_product_cate'] = '产品分类';
$_LANG['03_product_list'] = '产品列表';
$_LANG['04_product_service'] = '产品业务';
$_LANG['05_center_bank'] = '央行报告';
$_LANG['06_product_new'] = '解决方案';
$_LANG['07_product_new'] = '硬件版央行报告';
$_LANG['08_product_new'] = '消费清单';
/*APP管理*/
$_LANG['01_banner_admin'] = 'BANNER管理';
$_LANG['02_person_app'] = 'APP个人报告';
$_LANG['03_group_app'] = 'APP综合报告';
/* 菜单分类部分 */
...
$_LANG['17_weixin_manage'] = '微信模块'; // 增加 by www.charse.net 微商城
...
$_LANG['price_batch'] = '批量修改价格'; // 代码增加 By www.charse.net
//$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
/* 虚拟团购 代码增加 by www.charse.net start */
...
/* 虚拟团购 代码增加 by www.charse.net end */
...
/* 增值税发票_添加_START_www.charse.net */
$_LANG['12_invoice_list'] = '发票列表';
/* 增值税发票_添加_END_www.charse.net */
...
/* 代码添加_START By www.charse.net */
$_LANG['keyword'] = '客户搜索记录';
/* 代码添加_END By www.charse.net */
...
$_LANG['04_users_export'] = '会员导出'; // 代码增加 By www.charse.net
...
/* 权限管理 */
$_LANG['admin_user_list'] = '管理员列表';
$_LANG['admin_list_role'] = '管理员角色列表';
$_LANG['admin_role'] = '管理员角色管理';
$_LANG['admin_add'] = '添加管理员';
$_LANG['admin_add_role'] = '添加角色';
$_LANG['admin_edit_role'] = '修改角色';
$_LANG['admin_logs'] = '管理员日志';
$_LANG['agency_list'] = '办事处列表';
$_LANG['department_list'] = '部门列表';
$_LANG['privilege_list'] = '管理员权限列表';
...
/*代理商*/
$_LANG['07_supplier_new'] = '新增代理商';
$_LANG['oplist'] = '操作员列表';
$_LANG['07_supplier_newlist'] = '代理商列表';
$_LANG['07_supplier_logs'] = '代理商日志';
$_LANG['071_supplier_orderlist'] = '代理商订单记录';
$_LANG['08_supplier_role'] = '代理商角色管理';
$_LANG['09_supplier_assign_perm'] = '代理商权限管理';
$_LANG['10_supplier_pdt_scheme']='代理商产品方案';
$_LANG['11_supplier_sendmess'] = '发送代理商站内信';
$_LANG['12_supplier_messlist'] = '代理商站内信列表';

$_LANG['supplier'] = '代理商管理';
$_LANG['supplier_add'] = '代理商添加';
$_LANG['supplier_edit'] = '代理商编辑';
$_LANG['supplier_list'] = '代理商列表';
$_LANG['supplier_assign_perm'] = '权限分配';
...
/*机构*/
$_LANG['07_org_newlist'] = '机构列表';
/*机构管理*/
$_LANG['02_org'] = '机构管理';
$_LANG['org_list'] = '机构列表';
$_LANG['org_trans_log'] = '机构扣款记录';

/*征信产品*/
$_LANG['02_zxproduct'] = '征信产品管理';
$_LANG['zxproduct'] = '征信产品';
$_LANG['zxproduct_add'] = '添加产品';
$_LANG['zxproduct_category_add'] = '产品分类';
$_LANG['zxproduct_list'] = '产品列表';
$_LANG['zxproduct_server'] = '产品业务';

$_LANG['pro_name'] = '征信产品名称';
$_LANG['pro_no'] = '产品编号';
$_LANG['cat_id'] = '产品分类';
$_LANG['seconds'] = '更新频率';
$_LANG['price'] = '平台统一价';
$_LANG['selprior'] = '优先级别';
$_LANG['is_app'] = 'app是否显示';
$_LANG['pstatus'] = '服务是否启动';
$_LANG['isdown'] = '搜索结果是否可以下载';
$_LANG['iscomb'] = '是否可以组合';
$_LANG['iscom'] = '是否综合性产品';
$_LANG['prod_id2'] = '父级产品';

/*征信产品统计*/
$_LANG['02_zxproduct_statistics'] = '征信产品统计';
$_LANG['user_searchs'] = '用户查询';

$_LANG['02_database_statistics'] = '数据库统计';
...
/* 代码增加_end By supplier.68ecshop.com */
// 微信管理 增加 start by www.charse.net 微商城
...
// 增加 end by www.charse.net 微商城
$_LANG['website'] = '合作登录管理'; // 名字你可以自己定
/* 代码增加_start By www.charse.net */
...
$_LANG['proscoreauthorize'] = '征信个人评分信息回显';
$_LANG['personal_credit_score'] = '个人信用分';
$_LANG['kl_credit_score'] = '个人考拉信用分查询';



$_LANG['personal_credit'] = '个人信用报告查询';

$_LANG['business_iclaws'] = '企业工商注册信息查询';

$_LANG['ic_Verification'] = '工商核查';

$_LANG['ic_organization_code_certificate'] = '工商组织机构代码证查询';
$_LANG['ic_fourelements_info'] = '工商四元素信息认证';




//时信身份验证查询
$_LANG['1_identityQuery'] = '时信身份验证查询';
$_LANG['01_renlianshibie'] = '人脸识别';
$_LANG['02_validateFaceRecognition'] = '人证合一';
$_LANG['03_dizyz'] = '地址验证';
$_LANG['04_xuexwxx'] = '学信网数据';
$_LANG['05_zhiyxlxx'] = '职业学历信息';
$_LANG['06_zyxxcx'] = '职业信息查询';
$_LANG['061_corporation'] = '法人身份核验';
$_LANG['07_qrySingleProfessionalCerts'] = '职业资格证书';
$_LANG['08_validateIDCard'] = '身份证有效性';
$_LANG['09_gzdwyzQH'] = '工作单位验证';
$_LANG['10_qryEducationInfoReport'] = '个人学历报告';
$_LANG['11_guanlrgxyz'] = '关联人关系验证';
$_LANG['12_queryIDCard'] = '身份证照相片验证';
$_LANG['13_validateFaceRecognition2'] = '人证合一活体验证';
$_LANG['14_validateIDCard3'] = '多重交差身份验证(三渠道)';
$_LANG['15_validateIDCard5'] = '多重交差身份验证(五渠道)';
$_LANG['16_many_validate'] = '多渠道身份验证';
$_LANG['20_jsrdata'] = '驾驶人简要数据';

//$_LANG['2_fangchyzpg'] = '房产验证评估';
//时信资产验证查询
$_LANG['3_chelyz'] = '时信资产验证查询';
$_LANG['01_insurance'] = '社保';
$_LANG['02_gongjj'] = '公积金';
$_LANG['03_fangchyzh'] = '房产验证';
$_LANG['04_clyzQH'] = '车辆验证';
$_LANG['05_car_info'] = '车辆信息验证';
$_LANG['06_fangchshjpg'] = '房产售价评估';
$_LANG['07_driving_licence_ver'] = '驾驶证信息验证';
$_LANG['08_driving_licence_qry'] = '驾驶证状态查询';
$_LANG['09_jidcwzsj'] = '机动车违章数据';
$_LANG['10_jiaszztdb'] = '驾驶证状态对比';
$_LANG['11_cxywzsj'] = '车辆违章信息查询';
$_LANG['12_car_report_search'] = '车辆报告查询';



//时信银行卡
$_LANG['5_21_chat'] = '时信银行卡';
$_LANG['21_chat'] = '时信银行卡';
$_LANG['01_bankcompare'] = '银行汇率';
$_LANG['02_yinhkjq'] = '银行卡鉴权';
//$_LANG['01_Validation'] = '二元素验证';
//$_LANG['02_Validation'] = '三元素验证';
$_LANG['03_Validation'] = '三元素验证';
$_LANG['04_Validation'] = '四元素验证';
$_LANG['041_Validation'] = '六元素验证';
$_LANG['05_Validation'] = '银行卡有效性';
$_LANG['05_person_report'] = '个人报告查询';
$_LANG['06_personal_credit_report'] = '央行征信报告';
$_LANG['061_ws_personal_report']='详版个人征信';//挽手
$_LANG['07_yinhkzhyz'] = '银行卡综合验证';
$_LANG['08_yinhkzhpf'] = '银行卡综合评分';
$_LANG['09_creditemiallist'] = '信用卡邮箱账单';
$_LANG['091_data_tag'] = '持卡人交易数据标签';
$_LANG['14_trans_data'] = '银行卡交易查询';
$_LANG['10_Validation'] = '二元素验证(卡号+姓名)';
$_LANG['11_Validation'] = '二元素验证(卡号+手机号)';
$_LANG['12_Validation'] = '二元素验证(卡号+身份证号)';
$_LANG['12_Validation'] = '二元素验证(卡号+身份证号)';
$_LANG['13_skxz'] = '识卡寻踪';
$_LANG['13_skxz_detail'] = '识卡寻踪详细信息';


//时信手机通
$_LANG['6_txxx'] = '时信手机通';
$_LANG['01_shoujyz'] = '手机验证';
$_LANG['02_shoujyyy'] = '手机运营商';
$_LANG['03_ghxxcx'] = '固话信息查询';
$_LANG['04_shoujzhzz'] = '手机综合资讯';
$_LANG['05_getTimeLengthLabelByMdn'] = '电信号码在网时长';
$_LANG['06_getStateByMdn'] = '电信手机号码状态';
$_LANG['07_verifyIdNameByMdn'] = '电信号码三合一验证';
$_LANG['08_move_phone_time'] = '移动号码在网时长';
$_LANG['09_move_phone_check'] = '移动手机号码验证';
$_LANG['10_unicom_check'] = '联通手机号码验证';
$_LANG['11_move_phone_time2']='联通号码在网时长';
$_LANG['15_mobilelong_check']='手机号码在网时长(三网)';
$_LANG['17_city_verify']='手机号当前城市验证(三网)';
$_LANG['18_call_verify']='通话关系验证';
$_LANG['19_operators_rys_verify']='运营商二要素验证';
$_LANG['20_top_contacts_verify']='常用联系人';
$_LANG['21_city_stop_calculation_num']='手机号停机次数';

//时信航旅达
$_LANG['7_xingwxx'] = '时信航旅达';
$_LANG['airline_info'] = '乘机人统计查询';


//时信法院达
$_LANG['8_fumxx'] = '时信法院达';
$_LANG['01_hxfytQH'] = '法院通';
$_LANG['02_person_subject'] = '被执行人查询';
$_LANG['03_sxbzxr'] = '失信被执行人(老赖)';
$_LANG['04_courtNoticeIdx'] = '法院公告信息检索';
$_LANG['05_xsCourtNotice'] = '法院公告信息查询';
$_LANG['06_judgeDocIdx'] = '裁判文书信息检索';
$_LANG['07_xsJudgeDoc'] = '裁判文书信息查询';
$_LANG['08_dtfuzhai'] = '多头负债查询';


//时信反欺诈
$_LANG['90_fanqzyj'] = '时信反欺诈';
$_LANG['01_fengxyj'] = '风险预警';
$_LANG['02_fengxdts'] = '风险度提示';
$_LANG['03_qizdts'] = '欺诈度提示';
$_LANG['04_shilrxf'] = '失联人修复';
$_LANG['05_xinxssxf'] = '信息失联修复';
$_LANG['06_mjjdjl'] = '民间借贷记录';
$_LANG['07_chedfxyj'] = '车贷风险预警';
$_LANG['08_blacklist_info'] = '黑名单详细信息';
$_LANG['09_blacklist_warning_statistics'] = '黑名单预警统计';
$_LANG['10_blacklist_record'] = '黑名单记录数查询';
$_LANG['11_duodxwfxpg'] = '多贷行为风险评估';
$_LANG['12_blackListPersonBySth'] = '互联网金融同业黑名单';
$_LANG['13_badinfomation'] = '不良信息核查';
...
//时信时间分
$_LANG['91_xinypj'] = '时信时间分';
$_LANG['01_zucf'] = '租车分';
$_LANG['02_jiasf'] = '驾驶分';
$_LANG['03_xinyzhpf'] = '信用综合评分';
$_LANG['04_creMerchnt'] = '商户综合评分';
$_LANG['05_xinypfkl'] = '信用评分(kl)分';
$_LANG['06_xinypfqh'] = '信用评分(qh)分';
$_LANG['07_personal_credit_reporting'] = '个人信用报告';
$_LANG['08_good_data'] = '个人评分专业版';


//时信企业达
$_LANG['92_shenghyypf'] = '时信企业达';
$_LANG['01_creIndstToo'] = '好信工商通';
$_LANG['02_ic_info_comparison'] = '工商信息对比';
$_LANG['03_ic_invest'] = '工商企业投资信息查询';
$_LANG['04_ic_Enterprise_exchanges_information'] = '工商企业照面信息查询';
$_LANG['05_personal_iclaws'] = '个人工商注册信息查询';
$_LANG['06_qiyjyycsj'] = '企业经营异常信息数据';
$_LANG['07_gongsiggxx'] = '公司高管信息';
$_LANG['08_jingyingtong'] = '企业经营通';




$_LANG['93_tuozhanxx'] = '时信电商数据';
$_LANG['01_jingdong'] = '京东数据';
$_LANG['02_alipaypay'] = '支付宝数据';
$_LANG['03_taobao_embed'] = '淘宝-嵌入式';
$_LANG['04_alipay_embed'] = '支付宝-嵌入式';

$_LANG['person_bank_sqs'] = '个人央行授权书';
$_LANG['company_bank_sqs'] = '企业央行授权书';

$_LANG['shijianfen'] = '时间分';
$_LANG['hongmoshibie'] = '虹膜识别';
$_LANG['zhiwenshibie'] = '指纹识别';
$_LANG['changdaike'] = '常贷客';
$_LANG['haoxinshikongditu'] = '好信时空地图';
$_LANG['haoxinyingyan'] = '好信鹰眼QH';
$_LANG['haoxinchedaiguanjian'] = '好信车贷关键';
$_LANG['pcr_tologindown'] = '个人征信报告_快捷登录获取报告';
$_LANG['pcr_toLogin'] = '个人征信报告_登录&申请征信报告';
$_LANG['pcr_pbccrcSaveUser'] = '个人征信报告_注册';



//车模块
$_LANG['01_business_center'] = '业务中心';
$_LANG['01_Traffic_violation'] = '违章查询';
$_LANG['02_My_business'] = '我的业务';
$_LANG['03_Money_management'] = '资金管理';
$_LANG['04_Asset_management'] = '资产管理';
$_LANG['05_Mess_box'] = '消息盒子';

$_LANG['02_Supplier_management'] = '代理管理';
$_LANG['01_Supplier_list'] = '代理列表';
$_LANG['02_Supplier_order'] = '代理订单';
$_LANG['03_Supplier_assets'] = '代理资产';
$_LANG['04_Supplier_new'] = '新增代理商';

$_LANG['03_Statistical_reports'] = '统计报表';
$_LANG['01_Car_order'] = '订单类';
...
$_LANG['cfg_name']['shop_info'] = '公司信息';
$_LANG['cfg_name']['service_email'] = '客服邮件地址';
$_LANG['cfg_name']['service_phone'] = '客服电话';
$_LANG['cfg_name']['shop_logo'] = '公司 Logo';
$_LANG['cfg_name']['shop_notice'] = '公司简介';

//征信产品信息
$_LANG['apiprice']='供应商价格';
$_LANG['fstatus_list']='服务是否开启';
$_LANG['level']='优先级';
$_LANG['api_no']='供应商';

$_LANG['07_device_manager']="设备列表";
$_LANG['check_device_list']="待审核设备列表";
$_LANG['device_manager']="设备管理";
$_LANG['device_task']="设备更改任务清单";

$_LANG['device_add']="设备添加";

$_LANG['07_op_add']="添加操作员";
?>