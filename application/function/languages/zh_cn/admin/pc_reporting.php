 ...
 * ECSHOP 在线聊天客服语言文件
 * ============================================================================
 * * 版权所有 2008-2015 亚洲网视网络科技有限公司，并保留所有权利。
...
$_LANG['true_name'] = '姓名';
$_LANG['id_card'] = '身份号码';
$_LANG['bank_no'] = '银行卡预留手机号';


$_LANG['button_query'] = '查询';
$_LANG['notice_cus_card_no'] = '请输入银行卡号';
$_LANG['notice_cus_turename'] = '请输入姓名';
$_LANG['notice_id_card'] = '请输入姓名';
$_LANG['notice_bank_no'] = '请输入银行卡预留手机号';

/* 个人征信报告*/
$_LANG['pc_reporting'] = '个人征信信息';

$_LANG['source'] = '来源';
$_LANG['mobile'] = '手机号';
$_LANG['name'] = '姓名';
$_LANG['card'] = '银行卡号';
$_LANG['Date'] = '个人账单查询开始日期';
$_LANG['beginDate'] = '个人账单查询开始日期';
$_LANG['endDate'] = '个人账单查询结束日期';
$_LANG['identity'] = '身份证';



$_LANG['notice_source'] = '考拉征信服务平台分配';
$_LANG['notice_mobile'] = '11位的合法手机号';
$_LANG['notice_name'] = '请输入真实姓名';
$_LANG['notice_card'] = '银行卡号或银行卡识别码,只限一个';
$_LANG['notice_beginDate'] = '查询开始日期';
$_LANG['notice_endDate'] = '查询结束日期';
$_LANG['notice_identity'] = '请输入身份证号码';

$_LANG['download_reporting'] = '下载个人征信报告';
?>