...
$_LANG['privilege_list'] = '角色权限列表';
$_LANG['03_prod_scheme'] = '数据源方案';
$_LANG['admin_list'] = '管理员列表';
$_LANG['admin_role'] = '管理员角色列表';
...
//数据源管理
$_LANG['05_product_admin']="数据源管理";
$_LANG['01_product_add']="添加数据源";
$_LANG['02_product_cate']="数据源分类";
$_LANG['03_product_list']="数据源列表";
$_LANG['04_product_service']="数据源业务";
...
$_LANG['04_op_list']='操作员列表';
$_LANG['05_rlog_list']='代理商充值记录';
$_LANG['06_orglog_list']='机构充值记录';
$_LANG['07_supplier_consume']='代理商消费记录';
...
//代理商管理
$_LANG['071_supplier_order']='代理商订单记录';
...
//新产品权限
$_LANG["newproduct_management"]="新产品管理";
$_LANG["01_newproduct_list"]="新产品列表";
$_LANG["newproduct_cate"]="新产品分类";
$_LANG["03_newproduct_add"]="添加新产品";

$_LANG["edit_device"]="修改设备";
