...
$_LANG['cfg_desc']['shop_opint'] = '请输入店铺所在位置坐标用逗号隔开,例:x,y。<a target="blank" href="http://api.map.baidu.com/lbsapi/getpoint/index.dwt">坐标查询</a>';
...
$_LANG['cfg_desc']['time_shouhuo']      = '输入数字，如：输入48，代表最早送货时间为下订单起48小时后';
/* 代码增加_end  By  www.charse.net */
/*代码增加2014-12-23 by www.charse.net  _star */
...
/* 代码增加_注册红包start  By  www.charse.net */
...
/* 代码增加_注册红包end  By  www.charse.net */

$_LANG['cfg_name']['shop_opint'] = '店铺坐标';

$_LANG['cfg_name']['supplier2_admin'] = '代理商设置';
$_LANG['cfg_name']['supplier2_status'] = '代理数据源服务';
$_LANG['cfg_name']['supplier2_adm_pwd'] = '开发员密码设置';
$_LANG['cfg_name']['supplier2_auto_reg'] = '是否自动注册';
$_LANG['cfg_name']['supplier2_notice'] = '代理商公告';
$_LANG['cfg_name']['supplier2_max_record_num'] = '单个数据源最大记录输出数';
$_LANG['cfg_range']['supplier2_status'][0] = '关闭服务';
$_LANG['cfg_range']['supplier2_status'][1] = '开启服务';
$_LANG['cfg_range']['supplier2_auto_reg'][0] = '否';
$_LANG['cfg_range']['supplier2_auto_reg'][1] = '是';
?>