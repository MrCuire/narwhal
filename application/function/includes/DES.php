...
class DES
{
     ...
     * @param int $options
     */
    public function __construct($key, $method = 'DES-ECB', $output = '', $iv = '', $options = null)
    {
        if($options == null) {
...
// DES CBC 加解密
$des = new DES($key, 'DES_CBC', DES::OUTPUT_BASE64, $iv);
...
// DES ECB 加解密
$des = new DES($key, 'DES_ECB', DES::OUTPUT_HEX);
